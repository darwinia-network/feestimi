...
import { ormpLineAddresses, ormpExtLineAddresses, ormpAddresses } from "./addresses";
...
const buildEstimateFee = () => {
  const estimateFee: IEstimateFee = async (
    ...
    // PARAMS PREPARATION
    const srcOrmpLineAddress = ormpExtLineAddresses[fromChainId] || ormpLineAddresses[fromChainId]
    ...
    const tgtOrmpLineAddress = ormpExtLineAddresses[toChainId] || ormpLineAddresses[toChainId]
